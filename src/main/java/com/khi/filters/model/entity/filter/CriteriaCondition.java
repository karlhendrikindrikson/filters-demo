...
import static com.khi.filters.model.entity.filter.CriteriaType.*;
...
public enum CriteriaCondition {
    ...
    GREATER_THAN_EQUALS(List.of(AMOUNT)),
    ...
    FROM(List.of(AMOUNT, DATE, TITLE)),
    TO(List.of(AMOUNT, DATE, TITLE)),
    ;
